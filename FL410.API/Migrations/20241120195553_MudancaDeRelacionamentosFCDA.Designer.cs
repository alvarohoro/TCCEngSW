...
namespace FL410.API.Migrations
{
    ...
    [Migration("20241120195553_MudancaDeRelacionamentosFCDA")]
    partial class MudancaDeRelacionamentosFCDA
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FCDA", b =>
                {
                    b.HasOne("Aeronave", "Aeronave")
                        .WithMany()
                        .HasForeignKey("AeronaveId");

                    b.HasOne("FL410.Business.Models.Documentos.DA", "DA")
                        .WithMany()
                        .HasForeignKey("DAId");
